          ...
          <div class="x_panel">
              ...
              <div class="x_content">
                  ...
                  <!--@if($flag==1)-->
                      ...
                      <!--{{Form::hidden('id',null)}}-->
                  <!--@else-->
                      {{ Form::open(array('url'=>route('save-extrarevenue'),'id'=>"add-extrarevenue-form", 'class'=>"form-horizontal form-label-left")) }}
                  <!--@endif-->
                    <div class="row">
                        ...
                        <!--<input type="hidden" id="payment_date_new" value="{{date('Y-m-d',strtotime($data_row[0]->payment_date?? ''))}}">-->
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label class="control-label"> Date <span class="required">*</span></label>
                            <?php
                            ...
                            ?>
                            {{Form::date('payment_date_new',$dtPart ?? '',['class'=>"form-control datePickerDefault col-md-6 col-xs-12", "id"=>"payment_date_new", "autocomplete"=>"off", 'required', 'disabled'])}}
