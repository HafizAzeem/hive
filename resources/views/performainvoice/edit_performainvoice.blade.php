...
<div class="">
   @if($flag==1)
   {{ Form::model($data_row[0],array('url'=>route('update-performa'),'id'=>"update-arrival-form", 'class'=>"form-horizontal form-label-left",'files'=>true)) }}
   {{Form::hidden('id',null)}}
   @endif
            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        {{Form::date('advance_date',$datapaid ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"advance_date", "placeholder"=>"Advance Payment Date", "autocomplete"=>"off"])}}
                    </div>
                </div>
