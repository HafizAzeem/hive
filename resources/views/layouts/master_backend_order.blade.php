                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-10 main-section mycartposition">
                                        <div class="dropdown" id="count">
                                            <button type="button" class="btn btn-info" data-toggle="dropdown">
                                                ...
                                                <i class="fa fa-cutlery" aria-hidden="true"></i> Your Order <span class="badge badge-pill badge-danger">{{ count((array) session('cart')) }}</span>
                                            </button>
                                            <div class="dropdown-menu mydropmenu">
                                                    ...
                                                    @foreach(session('cart') as $id => $details)
                                                        <div class="row cart-detail">
                                                            ...
                                                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 cart-detail-product">
                                                                <p>{{ $details['name'] }}</p>
                                                                <span class="price text-info pricenewdesign"> ₹{{ $details['price'] }}</span> <span class="count"> Quantity:{{ $details['quantity'] }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12 col-xs-12 text-center checkout">
                                                        <a href="{{ route('cart') }}" class="btn btn-success btn-block">View Your Food Items</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
