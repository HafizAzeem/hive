            ...
            <div class="x_content">
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input class="form-control col-md-6 col-xs-12" autocomplete="off" onkeyup="moblie(this.value)" length="10" id="mobile" placeholder="Enter Mobile No." required="" name="mobile" type="number" value="{{$data_row->mobile ?? ''}}">
            ...
            <div class="x_content">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     {{Form::number('no_of_rooms',$data_row->room_qty ?? 1,['class'=>"form-control col-md-6 col-xs-12", "id"=>"no_of_rooms", "placeholder"=>lang_trans('No of Rooms'),"min"=>1, 'required'])}}
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                     ...
                     @if($data_row)
                        @if($data_row->package_price)
                           {{Form::text('booking_payment',$data_row->package_price ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","min"=>0])}}
                        @elseif($data_row->date_price)
                           {{Form::text('booking_payment',$data_row->date_price ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","min"=>0])}}
                        @else
                        
                           {{Form::text('booking_payment',$data_row->final_price ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","min"=>0])}}
                        @endif
                     @else
