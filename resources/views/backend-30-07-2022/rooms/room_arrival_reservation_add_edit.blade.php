            ...
            <div class="x_content">
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     {{Form::number('no_of_rooms',1,['class'=>"form-control col-md-6 col-xs-12", "placeholder"=>lang_trans('No of Rooms'),"min"=>1])}}
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="x_content">
               ...
               <div class="ln_solid"></div>
                ...
                <div class="col-md-6">
                   ...
                   <input type="number" class="form-control" name="gst_company" >
