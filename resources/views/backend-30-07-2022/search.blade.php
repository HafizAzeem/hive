...
$(".js-example-basic-single").select2({
  ...
  ajax: {
    url: "{{url('https://dashboard.f9hotels.com/api/getCustomer')}}",
    type: "post",
    dataType: 'json',
    delay: 250,
...
function f() {
	...
	window.location.href = "{{url('admin/newcheckin')}}/"+sv;
}
$("#search-input").on("select2:select", function (e) {
    window.location.href="{{url('admin/newexistscheckin')}}/"+e.params.data.id;
});
    </script>
@endsection