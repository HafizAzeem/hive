          ...
          <div class="x_panel">
              <div class="x_content">
                    <div class="row">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <input type="hidden" name="id" id="id" value="{{$deliveryid}}">
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <label>Mobile No <span>*</span></label>
                                                    <div class="moberr text-danger"></div>
                                                    {{Form::number('mobile',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"mobile",'required'])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <label>Customer Name <span>*</span></label>
                                                    <div class="custnameerr text-danger"></div>
                                                    {{Form::text('name',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"name",'required'])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                                    <label>Gst #</label>
                                                    {{Form::text('gstno',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"gstno"])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                                    <label>Pan #</label>
                                                    {{Form::text('panno',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"panno"])}}
                                                </div>
                                                
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <label>Address <span>*</span></label>
                                                    <div class="addresserr text-danger"></div>
                                                    {{Form::text('address',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"address",'required'])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                    <label>Building/Flat No. <span>*</span></label>
                                                    <div class="buildingflaterr text-danger"></div>
                                                    {{Form::text('buildingflatno',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"buildingflatno",'required'])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                    <label>Delivery Contact No.</label>
                                                    {{Form::number('deliverycontact',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"deliverycontact"])}}
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                    <label>Landmark</label>
                                                    {{Form::text('landmark',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"landmark"])}}
                                                </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <h3><a href="#"> KOT <span>{{$deliveryid}}</span> </a></h3>
                        </div>
                                ...
                                <div class="row">
                                    @if($dataall->isNotEmpty())
                                        ...
                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                            <h5 class="text-center">{{$value->foodname}}</h5>
                                        </div>
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                            <h5 class="text-center">{{$value->quantity}}</h5>
                                        </div>
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                            <h5 class="text-center">{{$value->rate}}</h5>
                                        </div>
                                        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bgsubdivmain">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                    {{ Form::text('foodname',null,['class'=>"form-control col-md-6 col-xs-12", 'placeholder'=>"custom item name", "id"=>"foodname",'required']) }}
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    {{ Form::number('rate',null,['class'=>"form-control col-md-6 col-xs-12", 'placeholder'=>"rate", "id"=>"rate",'required']) }}
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    {{ Form::number('quantity',1,['class'=>"form-control col-md-6 col-xs-12", "id"=>"quantity",'required']) }}
                                </div>
...
<script>
    ...
    $("#plus").click(function (e) {
        ...
        if(foodname == '') {
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('savedeliveryorder') }}",
                // dataType: 'json',
                data:{"_token": "{{ csrf_token() }}",delvid:delvid,foodname:foodname,rate:rate,quantity:quantity},
    ...
    $("#custaddressbtn").click(function (e) {
        ...
        if(mobile == '') {
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('savecustomerdetails') }}",
                // dataType: 'json',
                data:{"_token": "{{ csrf_token() }}",mobile:mobile,name:name,email:email,gstno:gstno,panno:panno,address:address,buildingflatno:buildingflatno,deliverycontact:deliverycontact,landmark:landmark},
                success:function(data){
                    console.log(data);
                    // if(data.datadelivery != ''){
                    //     window.location.reload();
