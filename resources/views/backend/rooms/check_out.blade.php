                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table class="table table-bordered" id="table_inclusive1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="td_total_room_amount exclusive">{{getCurrencySymbol()}} <span class="totalRoomAmount_span" id="total_booking_amount"> {{ numberFormat(round($amount)) }} </span></td>

                                        <td class="td_total_room_amount" id="second_total_amount" style="display:none">{{getCurrencySymbol()}}    <span class="second_totalRoomAmount_span" > {{ numberFormat(round($amount)) }} </span></td>
                                    </tr>
                                </tbody>
                                <table class="table table-bordered" id="table_inclusive2">
                                    <tr class="exclusive">
                                        ...
                                        <td width="15%" class="text-right td_total_room_amount">{{getCurrencySymbol()}} <span class="totalRoomAmount_span">{{ numberFormat(round($totalRoomAmount)) }} </span></td>
                                    </tr>
                                    <tr id="second_sub_total" style="display: none;">
                                        <th class="text-right">{{lang_trans('txt_subtotal')}} {{Form::hidden('amount[total_room_amount]',numberFormat($totalRoomAmount),['id'=>'total_room_amount'])}}</th>
                                        <td width="15%" class="text-right td_total_room_amount">{{getCurrencySymbol()}} <span class="second_totalRoomAmount_span" >{{ numberFormat(round($amount)) }} </span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" id="td_advance_amount" class="text-right">{{getCurrencySymbol()}} <span id="advance_payment_span">{{ numberFormat(round($advancePayment)) }} </span>
                                   ...
                                   {{-- @if($secadvancePayment)
                                    ...
                                    <tr class="exclusive">
                                        ...
                                        <td width="15%" id="td_room_final_amount" class="text-right">{{getCurrencySymbol()}} <span id="amount_payable_span" class="amount_payable_span">{{ numberformat(round($finalRoomAmount)) }} </span></td>
                                    ...
                                    <tr id="second" style="display:none">
                                        <th class="text-right">{{lang_trans('txt_amount_payable')}} {{Form::hidden('amount[total_room_final_amount]',null,['id'=>'total_room_final_amount'])}}</th>
                                        <td width="15%" id="td_room_final_amount" class="text-right">{{getCurrencySymbol()}} <span id="amount_payable_span_2" class="amount_payable_span">{{ numberformat(round($exclusiveAmount)) }} </span></td>
                            ...
                            <table class="table table-bordered">
                                <tr class="exclusive-food">
                                    ...
                                    <td width="15%" id="td_total_order_amount" class="text-right">{{getCurrencySymbol()}} {{ numberFormat($totalfoodamount) }}</td>
                                </tr>
                                <tr class="inclusive-food" style="display: none;">
                                    <th class="text-right">{{lang_trans('txt_subtotal')}} {{Form::hidden('amount[order_amount]',$totalOrdersAmount,['id'=>'total_order_amount'])}}</th>
                                    <td width="15%" id="td_total_order_amount" class="text-right">{{getCurrencySymbol()}} <span class="second_totalfoodamount">{{ numberFormat($totalOrdersAmount) }}</span> </td>
                                </tr>
                                <tr class="exclusive-food">
                                    ...
                                    <td width="15%" id="td_order_amount_gst" class="text-right">{{getCurrencySymbol()}} {{numberFormat($foodAmountGst)}}</td>
                                </tr>
                                <tr class="exclusive-food">
                                    ...
                                    <td width="15%" id="td_order_amount_cgst" class="text-right">{{getCurrencySymbol()}} {{numberFormat($foodAmountCGst)}}</td>
                                </tr>
                                <tr>
                                    <th class="text-right">{{lang_trans('txt_discount')}}</th>
                                    <td width="15%" id="td_advance_amount" class="text-right">
                            ...
                            <table class="table table-bordered">
                                <tr class="bg-success">
                                    ...
                                    <td width="15%" id="td_final_amount" class="text-right">{{getCurrencySymbol()}} <span id="grand_total_span">{{ numberFormat(round($totalOrdersAmount+$amount)) }}</span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                    ...
                    <button class="btn btn-success btn-submit-form 14" id="submit" type="submit">{{lang_trans('btn_submit')}}</button>
                </div>
            </div>
        </div>
    </div>
