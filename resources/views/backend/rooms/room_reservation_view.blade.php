...
<div class="">
    {{ Form::model($data_row,array('url'=>route('updateviewReservation'),'id'=>"updateviewReservation", 'class'=>"form-horizontal form-label-left",'files'=>true,'autocomplete'=>"off")) }}
    {{Form::hidden('id',null)}}
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <tr>
                              ...
                              <th>And Serial No.</th>
                              <td>{{$data_row->customer->and_number}}</td>
                              <th>Age</th>
                            ...
                            <tr>
                              ...
                              <td> {{Form::text('name',$data_row->customer->name ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"name", "placeholder"=>"Enter Name"])}} </td>
                              
                              <th>{{lang_trans('txt_mobile_num')}}</th>
                              <td> {{Form::number('mobile',$data_row->customer->mobile ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"mobile", "placeholder"=>"Mobile Number"])}} </td>
                              <!--<td>{{--$data_row->customer->mobile--}}</td>-->

                              <th>{{lang_trans('txt_email')}}</th>
                              <td> {{Form::email('email',$data_row->customer->email ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"email", "placeholder"=>"Enter Email"])}} </td>
                       ...
                       <div class="col-md-12 col-sm-12 col-xs-12">
                          <table class="table table-bordered">
                            <tr>
                              ...
                              <td>{{dateConvert($data_row->created_at_checkin,'d-m-Y H:i A')}}</td>
                            ...
                            <tr>
                              ...
                              <td> {{Form::text('company_gst_num',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"company_gst_num", "placeholder"=>"Enter GST Number"])}} </td>
                            </tr>
                            
                            <tr>
                                <th>Company Name</th>
                                <td>{{Form::text('gst_company',null,['class'=>"form-control col-md-6 col-xs-12",  "placeholder"=>"Enter Company Name"])}}</td>
                                <th>Company Address</th>
                                <td>{{Form::text('gst_address',null,['class'=>"form-control col-md-6 col-xs-12",  "placeholder"=>"Enter Company Address"])}}</td>
                            </tr>
