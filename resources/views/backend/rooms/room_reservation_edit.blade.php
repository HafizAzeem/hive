...
<div class="">
    ...
    {{Form::hidden('totalroom',$totalroom,['id'=>'totalroom'])}}
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input class="form-control col-md-6 col-xs-12" value="{{$data_row->customer->and_number}}" type="text" disabled>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input class="form-control col-md-6 col-xs-12" id="mobile" placeholder="Enter Mobile No." length="10" onkeyup="mobile1()" name="mobile" type="text" value="{{$data_row->customer->mobile}}" aria-invalid="true">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-2">
                           <label>Total Amount</label>
                            <!--<input type="text" value="{{$data_row->total_amount ?? 0}}" class="form-control" id="total_amount">-->
                            {{Form::text('total_amount',$data_row->total_amount,['class'=>"form-control col-md-6 col-xs-12","id"=>"total_amount"])}}
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <!--<input class="form-control col-md-7 col-xs-12" id="booking_payment"  min="0" name="booking_payment" type="text" value="{{numberFormat($data_row->per_room_price)}}" disabled>-->
                            {{Form::text('booking_payment1',$data_row->per_room_price,['class'=>"form-control col-md-6 col-xs-12","id"=>"booking_payment1"])}}
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            {{Form::select('payment_mode1',$payment_mode_list,$data_row->payment_mode,['class'=>"form-control col-md-6 col-xs-12","id"=>"payment1", "placeholder"=>"--Select"])}}
                        </div>
                        <div class="col-md-1">
                    ...
                    <input class="form-control col-md-4 col-xs-4" placeholder="Enter Advance Payment" disabled value="{{numberFormat($pp->payment)}}" type="number">                        
                    </div>                         
                    <div class="col-md-3">                             
                    <label>Remark</label>                                
                    ...
                    <div class="col-md-2">
                        ...
                        {{Form::text('pdateupdate[]',$pp->payment_date,['class'=>"form-control datepickerjc col-md-6 col-xs-12"])}}
