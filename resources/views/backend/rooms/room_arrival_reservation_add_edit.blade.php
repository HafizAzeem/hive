...
<!--<div class="">-->
    @if($flag==1)
        {{ Form::model($data_row,array('url'=>route('save-arrival'),'id'=>"update-arrival-form", 'class'=>"form-horizontal form-label-left",'files'=>true)) }}
        {{Form::hidden('id',null)}}
    @else
        {{ Form::open(array('url'=>route('save-arrival'),'class'=>"form-horizontal form-label-left",'files'=>true)) }}
    @endif
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label class="control-label"> And Serial No. </label>
                            {{Form::text('and_number',$getmid ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"and_number", "placeholder"=>"And Number", 'disabled'])}}
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            ...
                            {{Form::number('adult',1,['class'=>"form-control col-md-7 col-xs-12", "id"=>"adult", "required"=>"required","placeholder"=>lang_trans('ph_enter').lang_trans('txt_adults'),"min"=>1, 'required'])}}
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <label class="control-label"> {{lang_trans('txt_kids')}} </label>
                            {{Form::number('infant',0,['class'=>"form-control col-md-7 col-xs-12", "id"=>"infant", "required"=>"required","placeholder"=>"Enter infant(below 5)","min"=>0])}}
                        </div>
                          ...
                          <!--   {{Form::select('reason_visit_stay',config('constants.REASON'),null,['class'=>"form-control h34 col-md-6 col-xs-12", "id"=>"reason_visit_stay","rows"=>1])}}-->
                          <!--</div>-->
                        <div class="col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <?php
                            $dtPart2 = date('Y-m-d');
                            $to_date = Carbon::parse($dtPart2);
                            $dtpart3 = date('Y-m-d', strtotime(Carbon::now()->addDays(1)));
                            $from_date = Carbon::parse($dtpart3);
                            $totdays = $to_date->diffInDays($from_date);
                            // print_r($totdays);
                        ?>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 ">
                        ...
                        {{Form::text('check_out_date', $dtpart3,['class'=>"form-control datePickerDefault2 col-md-6 col-xs-12", "id"=>"check_out_date_my", "placeholder"=>lang_trans('ph_date'), "autocomplete"=>"off", 'required'])}}
                    </div>
                </div>
                <!-- <div class="row">
...
<!--</div>-->
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            {{ Form::select('room_type_id',$roomtypes_list ?? '',null,['class'=>'form-control', 'id'=>'newcheckin_room_type_id', 'placeholder'=>lang_trans('ph_select')]) }}
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label class="control-label"> {{lang_trans('No of Rooms')}} <span>*</span></label>
                            {{Form::number('no_of_rooms',1,['class'=>"form-control col-md-6 col-xs-12", 'id'=>'no_of_rooms', "placeholder"=>lang_trans('No of Rooms'),"min"=>1])}}
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" id="package_price_div" style="display : none;">
                            ...
                            {{Form::text('package_price',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"package_price", "placeholder"=>"Enter package price"])}}
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <label class="control-label"> {{lang_trans('txt_select_rooms')}}<span class="required">*</span></label>
                            <table class="table table-striped table-bordered">
            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="col-md-6">
                       ...
                       <input type="text" class="form-control" name="gst_address">
                    </div>
                    <div class="col-md-6">
                       <label>Total Payment</label>
                       <input type="number" class="form-control" name="payment" id="totalpayj" required>
                    </div>
                    <div class="col-md-6">
                       <label>Advance Payment</label>
                       <input type="number" class="form-control" name="advance" id="advancepayj">
                    </div>
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-success btn-submit-form2" type="submit"  id="arrivals_btn">{{lang_trans('btn_submit')}}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document" style="max-width: 80%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="btnSaveImage">Save Now</button>
                    <button type="button" id="close" class="btn btn-secondary" data-mdb-dismiss="modal">Close</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="colne_persons_info_elem hide_elem">
        <div class="row persons_info_elem">
            ...
            <div class="col-md-2 col-sm-1 col-xs-12">
                ...
                {{Form::file('persons_info[document_upload][]',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"document_upload", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_document_upload')])}}
            </div>
    ...
    <div class="colne_persons_info_kids hide_elem">
        <div class="row persons_info_elem">
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
                <label class="control-label"> {{lang_trans('txt_age')}} </label>
                {{Form::number('persons_info[age][]',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"person_age", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_age'),"max"=>10])}}
            </div>
            <div class="col-md-2 col-sm-1 col-xs-12">
                <label class="control-label"> {{lang_trans('txt_document_upload')}} <span class="required">*</span></label>
                {{Form::file('persons_info[document_upload][]',null,['class'=>"form-control col-md-6 col-xs-12", "id"=>"document_upload", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_document_upload')])}}
...
<script>
    ...
    $("#newcheckin_room_type_id").click(function(){
        var roomtypeidnew = $("#newcheckin_room_type_id").val();
        if(roomtypeidnew == 1){
            var date11 = $("#check_in_date_my").val();
            var date22 = $("#check_out_date_my").val();
        ...
        if(roomtypeidnew == 2){
            ...
            var totalpricetab = no_of_rooms*premiumroom*no_of_days;
            var totalprice = (totalpricetab).toFixed(2);
            $("#totalpayj").val(totalprice);
        }
        if(roomtypeidnew == 3){
            ...
            var totalpricetab = no_of_rooms*executiveroom*no_of_days;
            var totalprice = (totalpricetab).toFixed(2);
            $("#totalpayj").val(totalprice);
        }
    });
    ...
    $("#no_of_rooms").keyup(function(){
        ...
        if(roomtypeidnew == 1){
            ...
            var deluxroom = parseFloat($("#deluxroom").val());
            var no_of_rooms = parseFloat($("#no_of_rooms").val());
            var totalpricenew = no_of_rooms*deluxroom*no_of_days;
            var totalpricen = (totalpricenew).toFixed(2);
            $("#totalpayj").val(totalpricen);
        }
        if(roomtypeidnew == 2){
            var date11 = $("#check_in_date_my").val();
            var date22 = $("#check_out_date_my").val();
            ...
            var premiumroom = parseFloat($("#premiumroom").val());
            var no_of_rooms = parseFloat($("#no_of_rooms").val());
            var totalpricenew = no_of_rooms*premiumroom*no_of_days;
            var totalpricen = (totalpricenew).toFixed(2);
            $("#totalpayj").val(totalpricen);
        }
        if(roomtypeidnew == 3){
            ...
            var executiveroom = parseFloat($("#executiveroom").val());
            var no_of_rooms = parseFloat($("#no_of_rooms").val());
            var totalpricenew = no_of_rooms*executiveroom*no_of_days;
            var totalpricen = (totalpricenew).toFixed(2);
            $("#totalpayj").val(totalpricen);
        }
    ...
    $("#check_out_date_my").change(function(){
        var roomtypeidnew = $("#newcheckin_room_type_id").val();
        alert(roomtypeidnew);
        if(roomtypeidnew == 1){
            var date11 = $("#check_in_date_my").val();
    ...
    $("#advancepayj").keyup(function() {
        var advanced_payment = document.getElementById("advancepayj").value;
        var total_amount=document.getElementById("totalpayj").value;
        if(total_amount < advanced_payment)
        {
            $("#advancepayj").val('');
            swal({
                type: 'error',
