            ...
            <div class="x_content">
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        {{Form::text('booking_payment','',['class'=>"form-control col-md-7 col-xs-12 perroomprice", "id"=>"booking_payment", "placeholder"=>"Per Room Price","required", 'disabled'])}}
                    </div>
    ...
    $("#skipreason").click(function (e) {
        ...
        if(enterreason == '') {
            ...
            $.ajax({
                ...
                url:"{{ route('skipotp') }}",
                // dataType: 'json',
                data:{"_token": "{{ csrf_token() }}",mobileno:mobileno,enterreason:enterreason},
                success:function(data){
                    console.log(data);
                    if(data == 1){
                        $('.meassagnew').fadeIn('slow', function(){
