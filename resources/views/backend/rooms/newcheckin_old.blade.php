...
//print_r($getmid->value);
//return $getmid;
//print_r($roomtypes_list);
@endphp
<div class="">
            ...
            <div class="x_content">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        {{Form::text('and_number',$getmid ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"and_number", "placeholder"=>"And Number", 'required'])}}
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input class="form-control col-md-6 col-xs-12" autocomplete="off" onkeyup="moblie(this.value)" length="10" id="mobile" placeholder="Enter Mobile No." required="" name="mobile" type="number" value="{{$data_row->mobile ?? $mobile}}">
            ...
            <div class="x_content">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     {{ Form::select('room_type_id',$roomtypes_list ?? '',null,['class'=>'form-control cinroomtypeid',"id"=>"checkin_room_type_id",'placeholder'=>lang_trans('ph_select'), 'required']) }}
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                     <label class="control-label"> {{lang_trans('Price per Room')}} <span class="required" id="booking_payment_span">*</span></label>
                        {{Form::text('booking_payment','',['class'=>"form-control bookingpaymentnewclass col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","min"=>0])}}
...
<script>
    ...
    $('.cinroomtypeid').change(function() {
        var status = $('#checkin_room_type_id').val();
       
        if (status == 1) {
            var deluxroom = $('#deluxroom').val();
            alert(deluxroom);
            $('.bookingpaymentnewclass').val(deluxroom);
            var no_of_rooms = $("#no_of_rooms").val();
            var duration_of_stay = $("#duration_of_stay").val();
            var total_amount = duration_of_stay*no_of_rooms*deluxroom;
            var total_amount = (total_amount).toFixed(2);
            $("#total_amount").val(total_amount);
            
        }else if(status == 2){
            var premiumroom = $('#premiumroom').val();
            alert(premiumroom);
            $('.bookingpaymentnewclass').val(premiumroom);
            var no_of_rooms = $("#no_of_rooms").val();
            var duration_of_stay = $("#duration_of_stay").val();
            var total_amount = duration_of_stay*no_of_rooms*premiumroom;
            var total_amount = (total_amount).toFixed(2);
            $("#total_amount").val(total_amount);
        }else if(status == 3){
            var executiveroom = $('#executiveroom').val();
            alert(executiveroom);
            $('.bookingpaymentnewclass').val(executiveroom);
            var no_of_rooms = $("#no_of_rooms").val();
            var duration_of_stay = $("#duration_of_stay").val();
            var total_amount = duration_of_stay*no_of_rooms*executiveroom;
            var total_amount = (total_amount).toFixed(2);
            $("#total_amount").val(total_amount);
        }
    });
        ...
        $("#duration_of_stay").keyup(function(){
            //  var total_amount=$("[name=total_amount]").val();
             var duration_of_stay = $("#duration_of_stay").val();
             var no_of_rooms = $("#no_of_rooms").val();
             var price_per_room = $("#booking_payment").val();
             var total_amount = duration_of_stay*no_of_rooms*price_per_room;
             var total_amount = (total_amount).toFixed(2);
             $("#total_amount").val(total_amount);
