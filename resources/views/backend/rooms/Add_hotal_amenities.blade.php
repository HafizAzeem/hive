      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              ...
              <div class="x_content">
                  <br/>
                  @if(isset($flag))
                      {{ Form::model($data_row,array('url'=>route('save-hotalamenities'),'id'=>"amenities-form", 'class'=>"form-horizontal form-label-left")) }}
                      {{Form::hidden('id',null)}}
                  @else
                      {{ Form::open(array('url'=>route('save-hotalamenities'),'id'=>"amenities-form", 'class'=>"form-horizontal form-label-left")) }}
                  @endif
