        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <!--<form action="{{ route('payment') }}" method="POST" >-->
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label class="hotelstitle">Room Number {{ request()->route('id') }}</label>
                        <input type="hidden" name="roomnumberdj" id="roomnumberdj" value="{{ request()->route('id') }}">
...
<script>
    ...
    $(document).on("click","#add",function() {
        ...
        $("#totalprice").val(currentVal);
        $("#amounttotalfinal").html(currentVal);
