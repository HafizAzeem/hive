...
//                 ?>
              ...
              <tr class="mt-5 ml-5">
               ...
               <button class="btn-sm" style="background:yellow;color:black;">Check Out&ensp;&ensp;(<?php echo e($checked_rooms_count); ?>)</button>
                ...
                <?php elseif($key == 3): ?>
                <button class="btn-sm" style="background:blue;color:white;">OTA &ensp;&ensp;(<?php echo e($ota_rooms_count); ?>)</button>
                <?php elseif($key == 4): ?>
                ...
                <?php elseif($key == 6): ?>
                <button class="btn-sm" style="background:red;color:white;" >Block or R&M issue &ensp;&ensp;(<?php echo e($undermaintinance_count); ?>)</button>
                <?php elseif($key == 7): ?>
