                      ...
                      <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo e(route('check-out-room',[$val->id])); ?>"><?php echo e(lang_trans('btn_checkout')); ?></i></a>  href="<?php echo e(route('cancel-arrival',[$val->id])); ?>" -->
                        
                            <!--<a class="btn btn-danger btn-update-form cancelbtnpopup" id="cancelbtnpopup" value="<?php echo e($val->id); ?>" ><?php echo e(lang_trans('btn_cancel')); ?></a>-->
                            <a class="btn btn-danger btn-update-form" data-toggle="modal" data-target="#exampleModal<?php echo e($val->id); ?>" value="<?php echo e($val->id); ?>" >Cancel</a>
                            <!--<input type="hidden" name="jack[]" id="mainidnew" class="mainidnew" value="">-->
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/businessbuysell/public_html/pms/resources/views/backend/rooms/room_arrival_reservation_list_today.blade.php ENDPATH**/ ?>