                  ...
                  <table id="datatable__" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center"><?php echo e(lang_trans('Kitchen')); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td class="text-center" width="10%"><?php echo e(Form::checkbox('kitchen['.$val->id.']',null, ($val->kitchen==1) ? true: false )); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/permissions/list.blade.php ENDPATH**/ ?>