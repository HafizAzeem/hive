        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 class-inv-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                        ...
                        <spa class-inv-16n="">
                            <?php echo e(dateConvert($data_row->created_at_checkout,'d-m-Y h:i:A')); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 class-inv-6">
                    ...
                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        <span style="font-size: 15px;">
                            <?php echo e($data_row->customer->mobile); ?>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-center">
                        Room Charges
                        <?php if($data_row->meal_plan == 1): ?>
                            With CP
                        <?php elseif($data_row->meal_plan == 2): ?>
                            With EP
                        <?php elseif($data_row->meal_plan == 3): ?>
                            With MAP
                        <?php else: ?>
...
<?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/invoice.blade.php ENDPATH**/ ?>