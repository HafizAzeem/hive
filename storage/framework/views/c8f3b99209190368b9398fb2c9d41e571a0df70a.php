...
<html lang="en">
    ...
    <div>
        ...
        <div align="center" class="col-md-12 col-sm-12 col-xs-12">
            ...
            <a class="btn btn-sm btn-danger no-print" href="<?php echo e(route('dashboard')); ?>" id="back-btn">
...
</html><?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/backend/kitchen_invoice.blade.php ENDPATH**/ ?>