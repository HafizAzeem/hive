...
<div class="">
   ...
   <?php echo e(Form::hidden('per_room_price_new',null,['id'=>'base_priceprp'])); ?>
            ...
            <div class="x_content">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <!---->
                        <input class="form-control col-md-6 col-xs-12" autocomplete="off" onkeyup="moblie(this.value)" id="mobile" placeholder="Enter Mobile No." required="" name="mobile" type="number" value="<?php echo e($mobile); ?>">
                  ...
                  <!--   <?php echo e(Form::number('mobile',$data_row->mobile ?? '',['class'=>"form-control col-md-6 col-xs-12","length"=>"10" ,"id"=>"mobile", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_mobile_num'), 'required'])); ?>-->
                  <!--</div>-->
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     <?php echo e(Form::text('age',$data_row->age ?? '',['class'=>"form-control datePickerDefault1 col-md-6 col-xs-12", "id"=>"age", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_age'), "autocomplete"=>"off"])); ?>
                  ...
                  <div class="col-md-4 col-sm-2 col-xs-12">
                     ...
                     <?php echo e(Form::text('originally_referred_by',$data_row->referred_by_name ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"originally_referred_by", 'disabled', 'style'=>"background: mediumspringgreen"])); ?>
         ...
         <div class="x_panel">
            ...
            <div class="x_content">
               ...
               <div class="row ">
                  ...
                  <!--   <?php echo e(Form::text('vehicle_number',$data_row->vehicle_number ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"vehicle_number", "placeholder"=>lang_trans('ph_enter').lang_trans('txt_vehicle_number')])); ?>-->
                  <!--</div>-->
                  ...
                  <!--   <?php echo e(Form::select('reason_visit_stay',config('constants.REASON'),$data_row->reason_visit_stay ?? '',['class'=>"form-control h34 col-md-6 col-xs-12", "id"=>"reason_visit_stay","rows"=>1])); ?>-->
                  <!--</div>-->
                    <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <label class="control-label"> <?php echo e(lang_trans('txt_referred_by_name')); ?></label>
                     <?php echo e(Form::select('referred_by_name',config('constants.REFERRED_BY_NAME'),'OTA',['class'=>"form-control col-md-6 col-xs-12", "id"=>"referred_by_name"])); ?>
               ...
               <div class="row ">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <?php echo e(Form::number('duration_of_stay',$total_number_of_days ?? 1,['class'=>"form-control col-md-6 col-xs-12", "id"=>"duration_of_stay", "placeholder"=>lang_trans('txt_duration_of_stay'),"min"=>1, 'required'])); ?>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     <?php echo e(Form::number('no_of_rooms',$d ?? 1,['class'=>"form-control col-md-6 col-xs-12", "id"=>"no_of_rooms", "placeholder"=>lang_trans('No of Rooms'),"min"=>1, 'required'])); ?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            ...
            <div class="x_content">
               <div class="row">
                ...
                ?> 
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <?php echo e(Form::text('total_amount',$data_row->payment ?? '',['class'=>"form-control col-md-6 col-xs-12","id"=>"total_amount"])); ?>

                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <label class="control-label"> <?php echo e(lang_trans('Price per Room')); ?> <span class="required" id="booking_payment_span">*</span></label>
                        <?php echo e(Form::text('booking_payment',$data_row->payment ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment_new", "required", 'disabled'])); ?>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12"> <!--id="management" -->
                        ...
                        <?php echo e(Form::number('advance_payment',0,['class'=>"form-control col-md-7 col-xs-12", "id"=>"advance_payment", "placeholder"=>"Advance Payment","required"])); ?>
                ...
                ?> 
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <label class="control-label"> Total Price</label>
                        <?php echo e(Form::text('total_amount',$totgstnew ?? 0,['class'=>"form-control col-md-6 col-xs-12","id"=>"total_amount"])); ?>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12"> 
                        <label class="control-label"> <?php echo e(lang_trans('txt_advance_payment')); ?></label>
                        <?php echo e(Form::number('advance_payment',$data_row->advance ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"advance_payment", "placeholder"=>"Advance Payment","required"])); ?>
               ...
               if($data_row->advance){
                ...
                <div class="row" id="remove" style="display:block">  
                    <div class="col-md-3">                            
                        ...
                        <input class="form-control col-md-4 col-xs-4" placeholder="Enter Advance Payment" id='mainadvancenew' name="payment[]" min="0" type="number" value="<?php echo e($data_row->advance); ?>">                        
                    </div>                         
                    <div class="col-md-3">                            
                        <label class="control-label"> Payment Mode</label>                            
                         <?php echo e(Form::select('mode[]',$payment_mode_list ?? '',$data_row->payment_mode,['class'=>"form-control col-md-6 col-xs-12","id"=>"payment2", "placeholder"=>"--Select"])); ?>

                        </select>                       
                    </div>
                    <div class="col-md-3">
                        <label class="control-label">Advance Payment Date</label> 
                        <?php echo e(Form::text('pdateupdate[]',$date ?? '',['class'=>"form-control datepickerjc col-md-6 col-xs-12"])); ?>
               ...
               <!--   <button class="btn btn-success" style="display:none" id="first2" type="button" onclick="payment_link()"></button>-->
               <!--   <button class="btn btn-success" style="display:none" id="first4" type="button" onclick="paytm_Send_Link()"></button>-->
    ...
    $('#referred_by_name').ready(function() {
        ...
        else if(status == 'OTA')
        {
            ...
            html +=
                ...
                '<?php if($errors->has("ota")): ?><div class="error"><?php echo e($errors->first("ota")); ?></div><?php endif; ?>';
                $('#corporate').html(html);
        }
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/room_reservation_add_edit.blade.php ENDPATH**/ ?>