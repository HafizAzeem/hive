...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    <ul class="nav side-menu">
      ...
      <?php endif; ?>
      <?php if($permissionsArr['payment-master'] || $permissionsArr['add-payment-mode'] ): ?>
        <li><a><i class="fa fa-credit-card" aria-hidden="true"></i>Payment Master <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <?php if($permissionsArr['payment-master']==1): ?> <li><a href="<?php echo e(route('payment-master')); ?>">Payment Mode List </a></li> <?php endif; ?>
            <?php if($permissionsArr['add-payment-mode']==1): ?> <li><a href="<?php echo e(route('add-payment-mode')); ?>">Add Payment Mode</a></li> <?php endif; ?>
          </ul>
        </li>
      <?php endif; ?>
...
<?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/layouts/sidebar_backend.blade.php ENDPATH**/ ?>