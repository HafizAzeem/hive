...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php $total=0; ?>
                <?php $__currentLoopData = $data_row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                       <?php echo e($d->room_qty == 0 ? 1 : $d->room_qty); ?>

                    </td>
                    
                     <td class="text-center">
                        <?php echo e($d->room_num); ?>

                    </td>
                    
                    <td class="text-center">
                       <?php echo e($d->room_type->title); ?>
                    ...
                    <td class="text-center">
                         <?php echo e($d->duration_of_stay); ?>

                    </td>
                    <td class="text-center">
                     <?php echo e($d->booking_payment); ?>
            ...
            $cgstamount=round(($total*100)/$gstPerc);
                ...
                <tr>
                    ...
                    <td class="class-inv-17" colspan="5">
                        <?php echo e(getIndianCurrency(numberFormat(12345))); ?>
...
<?php endif; ?><?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/backend/newinvoice.blade.php ENDPATH**/ ?>