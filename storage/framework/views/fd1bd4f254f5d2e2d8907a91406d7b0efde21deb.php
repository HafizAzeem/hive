                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                          ...
                          <?php $__currentLoopData = $room_no; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room_no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <option value="<?php echo e($room_no->room_no); ?>"><tr>
                          <td><?php echo e($room_no->room_no); ?></td>  
                             </tr></option>
    ...
    function autoload()
          ...
          function deleteCoupon(id)
          {
                     ...
                     $.ajax({
                            method : 'get',
                            data : {id:id},
                            url : '<?php echo e(url("deleteCoupon")); ?>',
                            success : function(res)
                            {
                               autoload();
                            }
                ...
                $(document).ready(function(){
                    ...
                    $("#add").click(function(){
                        ...
                        $.ajax({
                            ...
                            url : '<?php echo e(url("/roomlight_action")); ?>',
                            // alert(data);
                            success : function(res)
                            {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/room_light.blade.php ENDPATH**/ ?>