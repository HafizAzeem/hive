                ...
                <div class="x_content"> 
                  <div class="row"> 
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      ...
                      <?php echo e(Form::text('name',$order_row->name,['class'=>"form-control col-md-6 col-xs-12", "id"=>"name", "placeholder"=>"Enter Fullname"])); ?>

                    </div>
                   <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_email')); ?> </label>
                      <?php echo e(Form::email('email',$order_row->email,['class'=>"form-control col-md-6 col-xs-12", "id"=>"email", "placeholder"=>"Enter Email Address"])); ?>

                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_mobile_num')); ?> </label>
                      <?php echo e(Form::text('mobile',$order_row->mobile,['class'=>"form-control col-md-6 col-xs-12", "id"=>"mobile", "placeholder"=>"Enter Mobile Number"])); ?>

                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_address')); ?> </label>
                      <?php echo e(Form::textarea('address',$order_row->address,['class'=>"form-control col-md-6 col-xs-12", "id"=>"address", "placeholder"=>"Enter Address","rows"=>1])); ?>

                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_table_num')); ?> </label>
                      <?php echo e(Form::select('table_num',getTableNums($order_row->id),$order_row->table_num,['class'=>"form-control col-md-6 col-xs-12", "id"=>"table_num", "placeholder"=>"--Select--", "required"=>true,'readonly'=>true,'disabled'=>true])); ?>

                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_num_of_persons')); ?> </label>
                      <?php echo e(Form::text('num_of_person',$order_row->num_of_person,['class'=>"form-control col-md-6 col-xs-12", "id"=>"table_num", "placeholder"=>"Enter  No. of Persons"])); ?>

                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> <?php echo e(lang_trans('txt_waiter_name')); ?> </label>
                      <?php echo e(Form::text('waiter_name',$order_row->waiter_name,['class'=>"form-control col-md-6 col-xs-12", "id"=>"table_num", "placeholder"=>"Enter Waiter Name"])); ?>
        ...
        <div class="x_panel">
          <div class="x_content">
             <table class="table table-bordered">
                  ...
                  <tr>
                    <th class="text-right"><?php echo e(lang_trans('txt_sgst')); ?>SGST (<?php echo e($gstPercFood); ?>%) <?php echo e(Form::hidden('gst_amount',null,['id'=>'gst_amount'])); ?></th>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/food_order_table_page.blade.php ENDPATH**/ ?>