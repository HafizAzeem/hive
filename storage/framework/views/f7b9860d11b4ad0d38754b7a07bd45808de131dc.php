            ...
            <div class="x_content">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input class="form-control col-md-6 col-xs-12" autocomplete="off" onkeyup="moblie(this.value)" length="10" id="mobile" placeholder="Enter Mobile No." required="" name="mobile" type="number" value="<?php echo e($data_row->mobile ?? ''); ?>">
            ...
            <div class="x_content">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                     ...
                     <!--      <?php echo e(Form::text('booking_payment',$data_row->package_price ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","disabled","min"=>0])); ?>-->
                     <!--   <?php elseif($data_row->date_price): ?>-->
                     <!--      <?php echo e(Form::text('booking_payment',$data_row->date_price ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","disabled","min"=>0])); ?>-->
                     <!--   <?php else: ?>-->
                     <!--      <?php echo e(Form::text('booking_payment',$data_row->payment ?? '',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required"])); ?>-->
                     <!--   <?php endif; ?>-->
                     <!--<?php else: ?>-->
                     <!--   <?php echo e(Form::text('booking_payment','',['class'=>"form-control col-md-7 col-xs-12", "id"=>"booking_payment", "placeholder"=>lang_trans('ph_enter').lang_trans('Booking Payment'),"required","disabled","min"=>0])); ?>-->
                     <!--<?php endif; ?>-->
                  </div>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/backend/rooms/room_reservation_add_edit.blade.php ENDPATH**/ ?>