...
<link rel="icon" href="<?php echo e(url('public/images/logo.jpg')); ?>" sizes="16x16" type="image/png">
			...
			<div class="col-md-12">
				<div class="col-middle">
					<div class="text-center text-center">
						...
						<h2>Access denied</h2>
						<p>Full authentication is required to access this resource.</a>
					</div>
				</div>
			</div>
		</div>
...
<?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/page_403.blade.php ENDPATH**/ ?>