              ...
              <div class="x_content">
                  <br/>
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo e(lang_trans('txt_room_rent_gst')); ?> (%) on amount(0 to 999)</label>
                      ...
                      <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo e(lang_trans('txt_room_rent_gst')); ?> (%) on amount(1000 to 2499)</label>
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <label class=""><?php echo e(lang_trans('txt_sgst')); ?> (%)</label>
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo e(lang_trans('txt_room_rent_gst')); ?> (%) on amount(2500 to 7499)</label>
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <label class=""><?php echo e(lang_trans('txt_sgst')); ?> (%)</label>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/settings.blade.php ENDPATH**/ ?>