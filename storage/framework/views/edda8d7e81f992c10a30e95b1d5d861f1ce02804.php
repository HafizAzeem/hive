...
<div class="">
    ...
    <?php echo e(Form::hidden('totalroom',$totalroom,['id'=>'totalroom'])); ?>
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input class="form-control col-md-6 col-xs-12" value="<?php echo e($data_row->customer->and_number); ?>" type="text" disabled>
                        </div>
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php echo e(Form::text('check_in_date',$data_row->check_in,['class'=>"form-control datePickerDefault col-md-6 col-xs-12", "id"=>"check_in", "placeholder"=>lang_trans('ph_date'),'readonly'=>true,'disabled'=>true, "autocomplete"=>"off"])); ?>

                            <input type="hidden" id="check_in_date_my" value="<?php echo e(date('Y-m-d',strtotime($data_row->check_in))); ?>">
                        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-2">
                           <label>Total Amount</label>
                            <!--<input type="text" value="<?php echo e($data_row->total_amount ?? 0); ?>" class="form-control" id="total_amount">-->
                            <?php echo e(Form::text('total_amount',$data_row->total_amount,['class'=>"form-control col-md-6 col-xs-12","id"=>"total_amount"])); ?>

                            <!--<input type="hidden" class="form-control" name="total_amountnew" id="total_amountnew">-->
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <label class="control-label"> Price per room</label>
                            <!--<input class="form-control col-md-7 col-xs-12" id="booking_payment"  min="0" name="booking_payment" type="text" value="<?php echo e(numberFormat($data_row->per_room_price)); ?>" disabled>-->
                            <?php echo e(Form::text('booking_payment1',$data_row->per_room_price,['class'=>"form-control col-md-6 col-xs-12","id"=>"booking_payment1"])); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php echo e(Form::select('payment_mode1',$payment_mode_list,$data_row->payment_mode,['class'=>"form-control col-md-6 col-xs-12","id"=>"payment1", "placeholder"=>"--Select"])); ?>
                    ...
                    <input class="form-control col-md-4 col-xs-4" placeholder="Enter Advance Payment" disabled value="<?php echo e(numberFormat($pp->payment)); ?>" type="number">                        
                    </div>                         
                    <div class="col-md-3">                             
                    <label>Remark</label>                                
                    <select class="form-control" name="payment_remark[]" disabled>
                         <?php $__currentLoopData = $remark; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($pp->remark==$r->title): ?>
                                <option value='<?php echo e($r->title); ?>' selected><?php echo e($r->title); ?></option>
                                <?php else: ?>
                        ...
                        <label class="control-label"> Payment Mode</label>                            
                         <?php echo e(Form::select('payment_mode[]',$payment_mode_list,$pp->mode,['class'=>"form-control col-md-6 col-xs-12","id"=>"payment2", "placeholder"=>"--Select"])); ?>

                        
                    </select>  
                    <input type="hidden" name="payment_history_ids[]" value="<?php echo e($pp->id); ?>">
                    </div>
                    <div class="col-md-2">
                        <label class="control-label">Payment Date</label> 
                        <?php echo e(Form::text('pdateupdate[]',$pp->payment_date,['class'=>"form-control datepickerjc col-md-6 col-xs-12"])); ?>
               ...
               <div class="col-md-6" style="font-size:18px;">
                   <?php  if($t_amount > $data_row->total_amount){ ?>
                       Extra Payment : <?php echo numberFormat($t_amount-$data_row->total_amount); ?>
                   <?php }else{ ?>
                       Total Pending Amount : <?php echo numberFormat($data_row->total_amount-$t_amount); ?>
                   <?php } ?>
...
$('#referred_by_name').change(function() {
    ...
    mobile1()
        ...
        $("[name=total_amount]").keyup(function(){
            ...
            $("#booking_payment1").val(price_per_room);
        })
        
        $("#duration_of_stay").keyup(function(){
            var duration_of_stay=$("#duration_of_stay").val();
            var booking_payment = $("#booking_payment1").val();
            var totalroom = $("#totalroom").val();
            var total_amount = booking_payment*duration_of_stay*totalroom;
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/room_reservation_edit.blade.php ENDPATH**/ ?>