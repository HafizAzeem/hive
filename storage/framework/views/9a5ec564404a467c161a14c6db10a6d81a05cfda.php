            ...
            <div class="x_content">
               <div class="row">
                  <div class="col-md-3 col-sm-3 col-xs-12">
                     <label class="control-label"> <?php echo e(lang_trans('Price per night')); ?> <span class="required" id="booking_payment_span">*</span></label>
                     <?php if($data_row): ?>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/rooms/room_reservation_add_edit.blade.php ENDPATH**/ ?>