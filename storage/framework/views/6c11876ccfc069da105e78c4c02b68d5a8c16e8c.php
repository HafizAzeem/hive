      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              ...
              <div class="x_content">
                  <br/>
                  <?php if($flag==1): ?>
                      <?php echo e(Form::model($data_row,array('url'=>route('save-ota'),'id'=>"edit-ota-form", 'class'=>"form-horizontal form-label-left"))); ?>

                      <?php echo e(Form::hidden('id',null)); ?>

                  <?php else: ?>
                      <?php echo e(Form::open(array('url'=>route('save-ota'),'id'=>"add-ota-form", 'class'=>"form-horizontal form-label-left"))); ?>
                  ...
                  <?php endif; ?>
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <select class="form-control col-md-6 col-xs-12 valid" id="referred_by_name" name="reconciliation" aria-invalid="false">
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/ota/ota_add_edit.blade.php ENDPATH**/ ?>