...
<div class="">
   <?php if($flag==1): ?>
   <?php echo e(Form::model($data_row[0],array('url'=>route('update-performa'),'id'=>"update-arrival-form", 'class'=>"form-horizontal form-label-left",'files'=>true))); ?>
            ...
            <div class="x_content">
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <?php
                            ...
                            if($data_row[0]->check_in){
                                $dtPart2 = $data_row[0]->check_in;
                            }else{
                                $dtPart2 = date('Y-m-d');
                            }
                            
                            
                            if($data_row[0]->check_out){
                                $dtPart3 = $data_row[0]->check_out;
                            }else{
                                $dtPart3 = date('Y-m-d');
                            }
                            
                            if($data_row[0]->advance_date){
                               $datapaid =  date("Y-m-d", strtotime($data_row[0]->advance_date));
                            }
                        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <?php echo e(Form::date('advance_date',$datapaid ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"advance_date", "placeholder"=>"Advance Payment Date", "autocomplete"=>"off"])); ?>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/performainvoice/edit_performainvoice.blade.php ENDPATH**/ ?>