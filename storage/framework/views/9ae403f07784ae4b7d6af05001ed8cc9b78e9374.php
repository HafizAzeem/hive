        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <br/>
                    <table id="datatablenew2" class="table table-striped table-bordered data-table">
                    <thead>
                      <tr>
                        <th>S.no</th>
                        <th><?php echo e(lang_trans('txt_guest_name')); ?></th>
...
$(document).ready(function(){
    $('#datatablenew2').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url:'<?php echo e(route("list-arrival-reservation")); ?>',
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/room_arrival_reservation_list.blade.php ENDPATH**/ ?>