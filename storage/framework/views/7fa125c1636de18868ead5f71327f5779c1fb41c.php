...
}else
{
 ...
 $totalRoomAmount = ($durOfStay * $bookingAmount * $count);
  $amount=$totalRoomAmount;
}
echo ($customer_room_data == "empty");
...
<?php
            ...
            $data_row1 = str_replace("public","storage",$data_row->customer->document);
?>
<img src="<?php echo e(asset('/'.$data_row1)); ?>"  height="120px" width="120px"><br><br>

<a href="<?php echo e(asset('/'.$data_row1)); ?>" class="btn btn-sm btn-success" download><i class="fa fa-download"></i> </a>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table class="table table-bordered" id="table_inclusive1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="td_total_room_amount exclusive"><?php echo e(getCurrencySymbol()); ?> <span class="totalRoomAmount_span" id="total_booking_amount"> <?php echo e(numberFormat($amount)); ?> </span></td>

                                        <td class="td_total_room_amount" id="second_total_amount" style="display:none"><?php echo e(getCurrencySymbol()); ?>    <span class="second_totalRoomAmount_span" > <?php echo e(numberFormat($amount)); ?> </span></td>
                                    </tr>
                                </tbody>
                                <table class="table table-bordered" id="table_inclusive2">
                                    <tr class="exclusive">
                                        ...
                                        <td width="15%" class="text-right td_total_room_amount"><?php echo e(getCurrencySymbol()); ?> <span class="totalRoomAmount_span"><?php echo e(numberFormat($totalRoomAmount)); ?> </span></td>
                                    </tr>
                                    <tr id="second_sub_total" style="display: none;">
                                        <th class="text-right"><?php echo e(lang_trans('txt_subtotal')); ?> <?php echo e(Form::hidden('amount[total_room_amount]',numberFormat($totalRoomAmount),['id'=>'total_room_amount'])); ?></th>
                                        <td width="15%" class="text-right td_total_room_amount"><?php echo e(getCurrencySymbol()); ?> <span class="second_totalRoomAmount_span" ><?php echo e(numberFormat($amount)); ?> </span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" id="td_advance_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <span id="advance_payment_span"><?php echo e(numberFormat($advancePayment)); ?> </span>
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" id="td_advance_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <span id="advance_sec_payment_span"><?php echo e(numberFormat($secadvancePayment)); ?> </span>
                                            <input type="hidden" id="default_sec_advance_payment" value="<?php echo e(numberFormat($secadvancePayment)); ?>">
                                        </td>
                                    </tr>
                                    <?php endif; ?>
                                    ...
                                    <tr class="exclusive">
                                        ...
                                        <td width="15%" id="td_room_final_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <span id="amount_payable_span" class="amount_payable_span"><?php echo e(numberformat($finalRoomAmount)); ?> </span></td>
                                    ...
                                    <tr id="second" style="display:none">
                                        <th class="text-right"><?php echo e(lang_trans('txt_amount_payable')); ?> <?php echo e(Form::hidden('amount[total_room_final_amount]',null,['id'=>'total_room_final_amount'])); ?></th>
                                        <td width="15%" id="td_room_final_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <span id="amount_payable_span_2" class="amount_payable_span"><?php echo e(numberformat($exclusiveAmount)); ?> </span></td>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td width="15%" id="td_total_order_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <?php echo e($totalOrdersAmount); ?></td>
                                </tr>
                                <tr class="exclusive-food">
                                    ...
                                    <td width="15%" id="td_order_amount_gst" class="text-right"><?php echo e(getCurrencySymbol()); ?> <?php echo e($foodAmountGst); ?></td>
                                </tr>
                                <tr class="exclusive-food">
                                    ...
                                    <td width="15%" id="td_order_amount_cgst" class="text-right"><?php echo e(getCurrencySymbol()); ?> <?php echo e($foodAmountCGst); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right"><?php echo e(lang_trans('txt_discount')); ?></th>
                                    <td width="15%" id="td_advance_amount" class="text-right">
                            ...
                            <table class="table table-bordered">
                                <tr class="bg-success">
                                    ...
                                    <td width="15%" id="td_final_amount" class="text-right"><?php echo e(getCurrencySymbol()); ?> <span id="grand_total_span"><?php echo e(numberFormat($finalRoomAmount)); ?></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/rooms/check_out.blade.php ENDPATH**/ ?>