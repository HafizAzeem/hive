        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br/>
                    <div class="form-group">
                        <?php //print_r($all_room_types[0]->id); ?>
                        <?php if(isset($all_room_types)): ?>
                            <?php $__currentLoopData = $all_room_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($art->title == 'DELUXE ROOM'): ?>
                                <div class="row">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> DELUXE ROOM</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php echo e(Form::number('deluxroom',@$data_row['deluxroom'],['class'=>"form-control col-md-7 col-xs-12", "required"=>true])); ?>
                                ...
                                <?php endif; ?>
                                <?php if($art->title == 'PREMIUM ROOM'): ?>
                                <div class="row">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> PREMIUM ROOM</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php echo e(Form::number('premiumroom',@$data_row['premiumroom'],['class'=>"form-control col-md-7 col-xs-12", "required"=>true])); ?>
                                ...
                                <?php endif; ?>
                                <?php if($art->title == 'EXECUTIVE ROOM'): ?>
                                <div class="row">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> EXECUTIVE ROOM</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php echo e(Form::number('executiveroom',@$data_row['executiveroom'],['class'=>"form-control col-md-7 col-xs-12", "required"=>true])); ?>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/businessbuysell/public_html/pms/resources/views/backend/settings.blade.php ENDPATH**/ ?>