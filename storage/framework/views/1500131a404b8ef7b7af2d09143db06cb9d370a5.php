                    ...
                    <div class="row">
                        <?php if($data_row->customer->Booking_id !=""): ?>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <input class="form-control col-md-6 col-xs-12" id="name" value="<?php echo e($data_row->customer->Booking_id); ?>" name="Booking_id" type="text" readonly>
                            </div>
                        <?php else: ?>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <label class="control-label"> Booking ID <span class="required"></span></label>
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input class="form-control col-md-7 col-xs-12" id="booking_payment"  min="0" name="booking_payment" type="text" value="<?php echo e($data_row->booking_payment * ($count + 1)); ?>">
                        </div>

                        
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label class="control-label"> Advance Payment</label>
                            <input class="form-control col-md-7 col-xs-12" id="advance_payment" placeholder="Enter Advance Payment" min="0" name="advance_payment" type="text" value="<?php echo e($data_row->advance_payment* ($count + 1)); ?>">
                        </div>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/rooms/room_reservation_edit.blade.php ENDPATH**/ ?>