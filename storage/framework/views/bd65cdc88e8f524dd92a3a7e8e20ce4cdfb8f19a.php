        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    $i=1;
                     use App\Reservation;
                     $pending=DB::select("SELECT `total_amount`,`id` as r_id ,(SELECT SUM(payment) FROM payment_history WHERE `reservations_id`=`r_id`) as payment FROM reservations where room_num!='' and is_deleted='0' and check_out is null and total_amount is NOT null HAVING total_amount > payment");
                     foreach($pending as $p)
                     {
                     $datalist=Reservation::whereStatus(1)->wherePaymentStatus(0)->whereIsDeleted(0)->whereNull('check_out')->orderBy('created_at','DESC')->distinct('room_num')->where('id', $p->r_id)->get();
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/lajpatnagar.f9hotels.com/new/resources/views/backend/rooms/pending_amount.blade.php ENDPATH**/ ?>