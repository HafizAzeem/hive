...
<div class="">
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              <div class="x_title">
                  <h2>Update Hotel Amenities</h2>
                  <div class="clearfix"></div>
              </div>
              <div class="x_content">
                  <br/>
                      <?php echo e(Form::model($data_row,array('url'=>route('update-hotelamenities'),'id'=>"amenities-form", 'class'=>"form-horizontal form-label-left"))); ?>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/newpms/resources/views/backend/rooms/hotel_amenities_add_edit.blade.php ENDPATH**/ ?>