      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              ...
              <div class="x_content">
                  <br/>
                  <?php if(isset($flag)): ?>
                      <?php echo e(Form::model($data_row,array('url'=>route('save-hotalamenities'),'id'=>"amenities-form", 'class'=>"form-horizontal form-label-left"))); ?>

                      <?php echo e(Form::hidden('id',null)); ?>

                  <?php else: ?>
                      <?php echo e(Form::open(array('url'=>route('save-hotalamenities'),'id'=>"amenities-form", 'class'=>"form-horizontal form-label-left"))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/rooms/Add_hotal_amenities.blade.php ENDPATH**/ ?>