                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <tr>
                              ...
                              <th>And Serial No.</th>
                              <td><?php echo e($data_row->customer->and_number); ?></td>
                              <th>Age</th>
                            ...
                            <tr>
                              ...
                              <td> <?php echo e(Form::text('name',$data_row->customer->name ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"name", "placeholder"=>"Enter Name"])); ?> </td>
                              
                              <th><?php echo e(lang_trans('txt_mobile_num')); ?></th>
                              <td> <?php echo e(Form::number('mobile',$data_row->customer->mobile ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"mobile", "placeholder"=>"Mobile Number"])); ?> </td>
                              <!--<td></td>-->

                              <th><?php echo e(lang_trans('txt_email')); ?></th>
                              <td> <?php echo e(Form::email('email',$data_row->customer->email ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"email", "placeholder"=>"Enter Email"])); ?> </td>
                              <!--<td></td>-->
                       ...
                       <div class="col-md-12 col-sm-12 col-xs-12">
                          <table class="table table-bordered">
                            <tr>
                              ...
                              <td><?php echo e(dateConvert($data_row->created_at_checkin,'d-m-Y H:i A')); ?></td>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/room_reservation_view.blade.php ENDPATH**/ ?>