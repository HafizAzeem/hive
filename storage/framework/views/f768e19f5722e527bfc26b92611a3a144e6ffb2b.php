                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php echo e(Form::text('and_number',$getmid ?? '',['class'=>"form-control col-md-6 col-xs-12", "id"=>"and_number", "placeholder"=>"And Number", 'disabled'])); ?>
            ...
            <div class="x_panel">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 ">
                        ...
                        <?php echo e(Form::text('check_out_date', $dtpart3,['class'=>"form-control datePickerDefault2 col-md-6 col-xs-12", "id"=>"check_out_date_my", "placeholder"=>lang_trans('ph_date'), "autocomplete"=>"off", 'required'])); ?>
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php echo e(Form::select('room_type_id',$roomtypes_list ?? '',null,['class'=>'form-control', 'id'=>'newcheckin_room_type_id', 'placeholder'=>lang_trans('ph_select')])); ?>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/rooms/room_arrival_reservation_add_edit.blade.php ENDPATH**/ ?>