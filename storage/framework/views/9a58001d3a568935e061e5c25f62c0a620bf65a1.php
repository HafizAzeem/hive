                      ...
                      <?php $__currentLoopData = $datalist3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                         ...
                         <?php if($val->is_deleted == 1): ?>
                          ...
                          <?php elseif(dateConvert($val->check_out,'d-m-Y') < date('d-m-Y') ): ?>
                          <td>
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/passerine/public_html/demo.collabr8.in/new/Sourcecode/9aug/newpms/resources/views/backend/rooms/room_arrival_reservation_list.blade.php ENDPATH**/ ?>