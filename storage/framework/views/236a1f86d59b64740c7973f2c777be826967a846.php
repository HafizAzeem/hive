                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label"> Room Number </label>
                        <select id="table_num" name="table_num" class="form-control col-md-12 roomnumberchange" required>
                             <option value="">---- select ---</option>
                            <?php $__currentLoopData = $skillsnew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->room_num); ?>"><?php echo e($item->room_num); ?></option>
...
<script>
    $(document).on('change','.roomnumberchange',function(e){
        e.preventDefault();
        var roomno = $(this).val();
        $.ajax({
            type:'POST',
            url:"<?php echo e(route('getrooomdatacustomer')); ?>",
            data:{"_token": "<?php echo e(csrf_token()); ?>",roomno:roomno},
            success:function(data){
                //console.log(data.roomnouserdata[0].customer.mobile);
                var name = data.roomnouserdata[0].customer.name;
                $('#name').val(name);
                var email = data.roomnouserdata[0].customer.email;
                $('#email').val(email);
                var mobile = data.roomnouserdata[0].customer.mobile;
                $('#mobile').val(mobile);
                var address = data.roomnouserdata[0].customer.address;
                $('#address').val(address);
            }
        });
    });
...
<?php echo $__env->make('layouts.master_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/f9hotels/public_html/pms.nextpro71.com/new/pms/resources/views/backend/room_food_order_page.blade.php ENDPATH**/ ?>